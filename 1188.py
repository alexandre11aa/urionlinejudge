...
#### tre a soma ou a média considerando somente aqueles elementos que estão na área inferior da matriz, conforme ilustrado abaixo(
#### área verde). A primeira linha de entrada contem um único caractere Maiúsculo O ('S' ou 'M'), indicando a operação (Soma ou Mé
#### dia) que deverá ser realizada com os elementos da matriz. Seguem os 144 valores de ponto flutuante de dupla precisão (double)
#### que compõem a matriz. Imprima o resultado solicitado (a soma ou média), com 1 casa após o ponto decimal. Q:1188
