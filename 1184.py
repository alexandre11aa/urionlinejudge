...
#### tre a soma ou a média considerando somente aqueles elementos que estão abaixo da diagonal principal da matriz, conforme ilust
...
#### matriz. Imprima o resultado solicitado (a soma ou média), com 1 casa após o ponto decimal. Q:1184
